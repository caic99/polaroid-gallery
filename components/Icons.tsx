...
export const Heart = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M19 14c1.49-1.28 3.6-2.36 4.57-4.57.53-1.21.53-2.58 0-3.79-.83-1.9-2.73-3.14-4.8-3.14-1.85 0-3.46.96-4.27 2.38-.81-1.42-2.42-2.38-4.27-2.38-2.07 0-3.97 1.24-4.8 3.14-.53 1.21-.53 2.58 0 3.79.97 2.21 3.08 3.29 4.57 4.57L12 21l7-7Z"/>
  </svg>
);
